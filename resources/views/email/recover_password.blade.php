						...
						<tbody>
							<tr>
								<td style="padding:30px 30px 20px 0px" class="masthead padded">
									<a href="https://www.poddinglabs.com" style="display:block;float:left" id="logo"><img src="{{ env('APP_URL') . '/assets/img/logo.png' }}" height="32px" alt="Logo HAF" style="-ms-interpolation-mode:bicubic;display:block;border:none; text-transform:upperca;" </a> </td> </tr> <tr>
								<td class="content">
												...
												<tr>
													<td style="padding:0 30px" class="padded">
														...
														<table border="0" cellpadding="0" cellspacing="0" width="100%" class="fullwidth" style="border-bottom:1px solid #e7e7e7">
															<tbody>
																<tr>
																	<td style="padding:20px 0;text-align:left;font-weight:500;font-size:24px;color:#343333" class="avenir" mc:edit="title">
																		<p style="text-transform: capitalize;">{{ $mailData['nama_persona'] }}</p>
																	</td>
																</tr>
																<tr>
															...
															<tbody>
																<tr>
																	<td style="padding:20px 80px 0 0;font-size:16px;line-height:167%;font-weight:400;color:#343333" mc:edit="copy 2">
																		<p>This link will self-destruct in 2 hours.<br> Didn’t ask for this email? Just ignore me. </p>
																	</td>
																</tr>
															</tbody>
														</table>

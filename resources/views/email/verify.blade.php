    ...
    {{ $mailData['body2']}}<br></p>
							  ...
							  <tr>
								<td style="padding:30px 0 60px 0" mc:edit="button">
									...
									<div align="left">
										<a data-qa="verification_link" href="{{ url('user/verify', $mailData['verification_code'])}}" style="text-decoration:none;color:#FFFFFF;background-color:#34aec9;display:inline-block;padding:18px 32px;margin:auto;border-radius:34px;font-size:px;font-weight:500" class="button">
																							Verify my email
																					</a>
									</div>
